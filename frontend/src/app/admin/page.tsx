...
import { useGetCustomersQuery } from './components/api/customersApi'
import { useGetUsersQuery } from './components/api/usersApi'
...
const AdminDashboardPage: React.FC = () => {
  ...
  const statsLoading = productsLoading || customersLoading || usersLoading
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <RecentProducts products={products.map(p => ({ id: p._id, name: p.name, status: p.isActive ? 'active' : 'inactive' }))} />
